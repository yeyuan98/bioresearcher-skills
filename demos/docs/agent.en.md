...
Current release: repo v1.4.1 with five independently versioned skills:

| Skill | Version | What it does |
|---|---|---|
| `bioresearcher-deep-research` | 1.1.1 | Deep-research orchestrator: clarify → decompose into 2–5 aspects → parallel (or sequential) investigation → fully cited Markdown + HTML report |
